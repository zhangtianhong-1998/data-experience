...
- [Beyond Text-to-SQL: Governed Enterprise Analytics APIs](https://arxiv.org/abs/2605.21027)

## SQL、lineage 与 provenance
...
- [OpenMetadata AI SDK/MCP](https://docs.open-metadata.org/v1.12.x/api-reference/sdk/ai-sdk)
- [OpenMetadata Metrics](https://docs.open-metadata.org/v1.12.x/how-to-guides/data-governance/metrics)
...
- [Cube data model](https://docs.cube.dev/reference/data-modeling/cube)
...
- [MindsDB Engine](https://mindsdb.github.io/engine/)
...
- [Splink clustering](https://moj-analytical-services.github.io/splink/api_docs/linker_clustering.html)
- [Ditto](https://github.com/megagonlabs/ditto)
- [Panda weakly supervised entity matching](https://arxiv.org/abs/2106.10821)
- [Ground Truth Inference for Weakly Supervised Entity Matching](https://arxiv.org/abs/2211.06975)
